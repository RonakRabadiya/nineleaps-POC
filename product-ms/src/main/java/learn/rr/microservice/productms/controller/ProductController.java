...
public class ProductController {
	...
	public List<ProductDto> getAllProducts(
			@RequestParam(name = "products", required = false, defaultValue = "") List<UUID> productIds) {
	...
	public ResponseEntity<ProductDto> updateProduct(@PathVariable("productid") @NotNull UUID id,
			@Valid @RequestBody ProductDto productDto) throws BusinessException {
